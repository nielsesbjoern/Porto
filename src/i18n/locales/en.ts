...
export const en: Dictionary = {
  ...
  sections: {
    ...
    evening1: {
      navLabel: "Evening 1",
      title: "Evening 1 — Matosinhos: Beach & Fish",
      intro:
    ...
    morning2: {
      ...
      stops: {
        ...
        "m2-vandoma": {
          title: "If it's a Saturday: Feira da Vandoma",
          tag: "Antiquarian flair",
          body: "Porto's flea market — old books, coins, the kind of stock a crime-novel antiquarian would sell. Saturdays only, 8am–1pm, a bit out of the way (metro via Campanhã). If your day lands on one, put it at the start and shift the tasting later.",
          meta: "Saturdays 8am–1pm",
        },
      },
    },
    evening2: {
      navLabel: "Evening 2",
      title: "Evening 2 — Rodízio & jazz on the Douro",
      intro:
